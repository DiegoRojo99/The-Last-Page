      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          <div className="bg-white p-4 rounded-lg shadow-sm border">
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-800">{bookCounts.reading}</div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm border">
            <div className="text-center">
              <div className="text-2xl font-bold text-black">{bookCounts.notStarted}</div>
              <div className="text-sm text-gray-600">Want to Read</div>
            </div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-sm border">
            <div className="text-center">
              <div className="text-2xl font-bold text-red-600">{bookCounts.abandoned}</div>
              <div className="text-sm text-gray-600">Abandoned</div>
            </div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-sm border">
            <div className="text-center">
              <div className="text-2xl font-bold text-yellow-600">{bookCounts.wishlist}</div>
            ...
            {fetchLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <button
                  ...
                  className="bg-gray-800 text-white px-6 py-2 rounded-lg hover:bg-gray-500 transition-colors"
                >

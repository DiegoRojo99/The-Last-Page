...
export default function BookCoverBackground({ book }: { book: CompleteUserBook | null }) {
  if (!book) {
  ...
  return (
    <div className="relative h-[300px] w-full">
      <Image
        src={book?.userInfo.coverImage || "/default-cover.jpg"}
      ...
      <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <Image
          src={book?.userInfo.coverImage || "/default-cover.jpg"}
          alt={book?.userInfo.title || "Book Cover"}
